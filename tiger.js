...
bot.command({
  ...
  code: `
  $description[
**Tüm Korumaların Birisini Etkilemesini İstemiyorsanız** \`t/beyazliste-ekle/sil @Kişi\`
**Prefix Değiştirme** \`t/prefix-ayarla\`
**Sunucudaki Prefixim** \`$getServerVar[prefix]\`

<:police1:848886750977589269> **Reklam Koruma Sistemini Görmek İçin** \`t/reklam-koruma\`
<:police1:848886750977589269> **Küfür Koruma Sistemini Görmek İçin** \`t/küfür-koruma\`
<:police1:848886750977589269> **Spam Koruma Sistemini Görmek İçin** \`t/spam-koruma\`
<:police1:848886750977589269> **Caps Lock Koruma Sistemini Görmek İçin** \`t/caps-koruma\`
<:police1:848886750977589269> **Etiket Koruma Sistemini Görmek İçin** \`t/etiket\`
<:police1:848886750977589269> **Yeni Hesap Koruma Sistemini Görmek İçin** \`t/yeni-hesap-koruma\`
 
Diğer Komutlar
<a:moderatr:805348521225879552> \`t/moderasyon\`(23)
<a:yulduz:805183294656348160> \`t/kullanıcı\`(7)
<a:dj:849973260116033556> \`t/müzik\`(7)
...
bot.command({
  name: "login-freevds",
  code: `
$argsCheck[>1;Login Kodunu gir!]
$if[$message[1]==2314723556]
$giveRole[$authorid;957215420773969972]
$deletecommand
<@$authorid> Login Başarılı!
$suppressErrors[]
$endif
`,
});
...
<:police1:848886750977589269> **Botta Bir Sorun Yaşarsanız** \`t/bug\`
]
$color[ORANGE]
...
bot.rateLimitCommand({
  channel: "850429964788563998",
  code: `
Zaman: $rateLimit[timeout]
Sınır: $rateLimit[limit]
Yöntem: $rateLimit[method]
Yol: $rateLimit[path]
...
$color[BLUE]
$description[
**Reklam Koruma** $replaceText[$replaceText[$getServerVar[reklamkoruma2];yes;<:ac:836174680913215518>;1];no;<:kap:836174628547723274>;1] ($replaceText[$replaceText[$checkCondition[$getServerVar[reklamkoruma]!=];false;<:kap:836174628547723274>;-1];true;<#$getServerVar[reklamkoruma]>;-1])
**Küfür Koruma** $replaceText[$replaceText[$getServerVar[kfkoruma2];yes;<:ac:836174680913215518>;1];no;<:kap:836174628547723274>;1] ($replaceText[$replaceText[$checkCondition[$getServerVar[kfkoruma]!=];false;<:kap:836174628547723274>;-1];true;<#$getServerVar[kfkoruma]>;-1])
**Spam Koruma** $replaceText[$replaceText[$getServerVar[spamkoruma2];yes;<:ac:836174680913215518>;1];no;<:kap:836174628547723274>;1] ($replaceText[$replaceText[$checkCondition[$getServerVar[spamkoruma]!=];false;<:kap:836174628547723274>;-1];true;<#$getServerVar[spamkoruma]>;-1])
**Caps Koruma** $replaceText[$replaceText[$getServerVar[caps];yes;<:ac:836174680913215518>;1];no;<:kap:836174628547723274>;1] ($replaceText[$replaceText[$checkCondition[$getServerVar[capslog]!=];false;<:kap:836174628547723274>;-1];true;<#$getServerVar[capslog]>;-1])
**Yeni Hesap Koruma** $replaceText[$replaceText[$getServerVar[alt];yes;<:ac:836174680913215518>;1];no;<:kap:836174628547723274>;1] ($replaceText[$replaceText[$checkCondition[$getServerVar[altchan]!=];false;<:kap:836174628547723274>;-1];true;<#$getServerVar[altchan]>;-1])]
$onlyIf[$getGlobalUserVar[bakım]!=true;{description:Şuanda Bakım Modum Açık Daha Sonra Tekrar Deneyin
> Bakım Sebebi **$getGlobalUserVar[bakımsbp]**
[Destek Sunucum](https://discord.gg/UATm97gZeg) }{color:GREEN}{delete:5s}
$onlyIf[$getGlobalUserVar[karaliste;$authorid]!=true;{description:Karalisteye Alındığın İçin Komutları Kullanamazsın
 ...
 **Onaylama**
   ...
   $argsCheck[>2;Lütfen geçerli bir sebep yazın.]
   $argsCheck[>1;Birisini Etiketle Ve Geçerli Bir sebep yaz]
...
$onlyIf[$message[2]>0;1'Den Düşük Etiket Engel Sayısı ayarlıyamazsın.]
...
bot.command({
  name: "$alwaysExecute",
  code: `
$ban[$authorid;Tiger Etiket Engel / Banned]
$author[$userTag[$authorID] banned;$authorAvatar]
$description[**Sebep**: Aşırı Bahsetme
$setUserVar[etiketu;$sum[$getUserVar[etiketu];1]]
$color[#2C2F33]
...
bot.command({
  ...
  code: `
$deletecommand
$title[Bigo TV | Yayın Başladı]
$description[Destek Yapılcak Yayın  **\`Bigo TV\`** Yazısına Tıklayarak Katılabilirisin Mobil Kullanıcılar Aşşağıdaki İd Kopyalayıp Katılabilir.
 [BİGO TV ](https://www.bigo.tv/tr/$message)]
$color[PURPLE]
$onlyIf[$isBot[$authorid]!=true;]
$onlyForChannels[957280719531544650;]
$onlyForServers[957280718336180264;]
$suppressErrors[]
`,
}); 
